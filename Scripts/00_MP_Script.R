...
source("Scripts/1_spatial_carpentry.R")
...
source("Scripts/2_MP_data_processing.R")
...
source("Scripts/4_current_trends.R")
...
source("Scripts/5_MP_predictions.R")
...
source("Scripts/6_regression-kriging_100000.R")

#Regression kriging maps
source("Scripts/7_regression-kriging_maps")
